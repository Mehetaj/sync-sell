import { INewArrival } from "@/components/new-arrival-table";
import { createSlice, createAsyncThunk } from "@reduxjs/toolkit";
import axios from "axios";
import { WritableDraft } from "immer";
import { toast } from "react-toastify";

// Define the schema for your NewArrival model
...
interface NewArrivalState {
  items: WritableDraft<NewArrival>[];
  loading: boolean;
...
export const addNewArrival = createAsyncThunk(
  ...
  async (newArrival: NewArrival): Promise<NewArrival[]> => {
...
export const deleteNewArrival = createAsyncThunk(
  ...
  async (id: string): Promise<NewArrival[]> => {
