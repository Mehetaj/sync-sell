...
interface ProductState {
  items: WritableDraft<Product>[]; // List of products
  loading: boolean; // Loading state flag
  status: "idle" | "loading" | "succeeded" | "failed"; // Status flag
...
export const editProduct = createAsyncThunk(
  ...
  async ({ updatedProduct, id }: { updatedProduct: Product; id: string }): Promise<Product[]> => {
