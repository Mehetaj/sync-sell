...
const EditNewArrival = () => {
    ...
    const newArrivals = useSelector((state: RootState) => state.newArrival.items)

    const [formData, setFormData] = useState<INewArrival>({
        _id: "",
        name: "",
        price: "",
        image: "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error("Failed to update new arrival. Please try again.");
        }
        setIsLoading(false);
    };
