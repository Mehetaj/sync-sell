...
import { deleteNewArrival, fetchNewArrivals } from "@/app/store/features/new-arrival-slice";
import { toast } from "react-toastify";
import { Plus } from "lucide-react";

const NewArrivalPage = () => {
    const dispatch = useDispatch<AppDispatch>();
    const { items: newArrivals, loading, error } = useSelector((state: RootState) => state.newArrival);
